...
def metrics_store(cfg, read_only=True, workload=None, procedure=None, cluster_config=None, meta_info=None):
    """
    ...
    store.open(
        ...
        workload, procedure, selected_cluster_config,
...
class MetricsStore:
    ...
    def open(self, test_ex_id=None, test_ex_timestamp=None, workload_name=None,\
         procedure_name=None, cluster_config_name=None, ctx=None,\
         create=False):
        """
        Opens a metrics store for a specific test_execution, workload, procedure and cluster_config.
        ...
        "procedure=[%s], cluster_config=[%s]",
                         self._test_execution_timestamp, self._workload, self._procedure, self._cluster_config)
    ...
    def flush(self, refresh=True):
        if self._docs:
            ...
            self.logger.info("Successfully added %d metrics documents for test execution timestamp=[%s], workload=[%s], "
                             "procedure=[%s], cluster_config=[%s] in [%f] seconds.",
                             len(self._docs), self._test_execution_timestamp,
                             self._workload, self._procedure, self._cluster_config, sw.total_time())
        self._docs = []
...
def create_test_execution(cfg, workload, procedure, workload_revision=None):
    ...
    workload_params, procedure, cluster_config, cluster_config_params,
...
class TestExecution:
    def __init__(self, benchmark_version, benchmark_revision, environment_name,
                 ...
                 workload, workload_params, procedure, cluster_config,
